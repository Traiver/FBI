...
static list_item delete_pending_title = {"Lösche ausstehenden Title", COLOR_TEXT, action_delete_pending_title};
static list_item delete_all_pending_titles = {"Lösche alle ausstehenden Titles", COLOR_TEXT, action_delete_all_pending_titles};
...
static void pendingtitles_action_open(linked_list* items, list_item* selected) {
    ...
    list_display("Pending Title Action", "A: Auswählen, B: Zurück", data, pendingtitles_action_update, pendingtitles_action_draw_top);
}
...
void pendingtitles_open() {
    ...
    list_display("Ausstehende Titles", "A: Auswählen, B: Zurück, X: Aktualisieren", data, pendingtitles_update, pendingtitles_draw_top);
}